 ...
 */
class getCompteurmatriculeProfesseurRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompteurmatriculeProfesseurRepository' shared autowired service.
     *
     * @return \App\Repository\CompteurmatriculeProfesseurRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompteurmatriculeProfesseurRepository.php';

        return $container->privates['App\\Repository\\CompteurmatriculeProfesseurRepository'] = new \App\Repository\CompteurmatriculeProfesseurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
