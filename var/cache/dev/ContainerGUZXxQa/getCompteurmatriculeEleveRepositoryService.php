 ...
 */
class getCompteurmatriculeEleveRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CompteurmatriculeEleveRepository' shared autowired service.
     *
     * @return \App\Repository\CompteurmatriculeEleveRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CompteurmatriculeEleveRepository.php';

        return $container->privates['App\\Repository\\CompteurmatriculeEleveRepository'] = new \App\Repository\CompteurmatriculeEleveRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
