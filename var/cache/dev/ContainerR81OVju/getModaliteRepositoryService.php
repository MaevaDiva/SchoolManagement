 ...
 */
class getModaliteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModaliteRepository' shared autowired service.
     *
     * @return \App\Repository\ModaliteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModaliteRepository.php';

        return $container->privates['App\\Repository\\ModaliteRepository'] = new \App\Repository\ModaliteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
