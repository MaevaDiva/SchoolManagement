 ...
 */
class getProfesseurRepositoryService extends App_KernelDevDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProfesseurRepository.php';

        return $container->privates['App\\Repository\\ProfesseurRepository'] = new \App\Repository\ProfesseurRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
